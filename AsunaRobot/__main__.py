...
PM_START_TEXT = """
`Hello` [🧚‍♀️](https://telegra.ph/file/27868074fe4a37caa47da.jpg) `My name is` *Aliza*
...
buttons = [
    ...
    [
        InlineKeyboardButton(text="🗨️ Updates", url="https://t.me/ALIZA_SUPPORT"),
        InlineKeyboardButton(
            text="👥 SUPPORT", url="https://t.me/Aliza_XD"
        ),
    ],
    [
        InlineKeyboardButton(
            text="💾 Source Code", url="https://t.me/XD_LIF"
        ),
    ],
]
...
HELP_STRINGS = """
`Hi.. I'm` [Aliza ⚙️]("https://telegra.ph/file/27868074fe4a37caa47da.jpg") 
`Click on the buttons below to get documentation about specific modules..`"""


ASUNA_IMG = "https://telegra.ph/file/27868074fe4a37caa47da.jpg"

DONATE_STRING = """Heya, glad to hear you want to donate!
 You can support the project via [Paypal](#) or by contacting @XD_LIF\
...
def asuna_about_callback(update, context):
    ...
    if query.data == "asuna_":
        query.message.edit_text(
            text=""" ❗ I'm *Aliza*, a powerful group management bot built to help you manage your group easily.
...
def donate(update: Update, context: CallbackContext):
    ...
    if chat.type == "private":
        ...
        if OWNER_ID != 1979533321 and DONATION_LINK:
            update.effective_message.reply_text(
    ...
    if SUPPORT_CHAT is not None and isinstance(SUPPORT_CHAT, str):
        try:
            dispatcher.bot.sendMessage(
                f"@{SUPPORT_CHAT}",
                "[Yes I'm alive now!](https://telegra.ph/file/27868074fe4a37caa47da.jpg)",
                parse_mode=ParseMode.MARKDOWN,
            )
        except Unauthorized:
            LOGGER.warning(
